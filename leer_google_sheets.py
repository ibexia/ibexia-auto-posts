...
<p>[Aquí, la IA debe elaborar una proyección fundamentada (mínimo 150 palabras) con párrafos de máximo 3 líneas. Debe integrar estas cifras con una interpretación crítica de la solvencia, rentabilidad, crecimiento y las perspectivas estratégicas de la empresa, y **mojarse** con una valoración clara sobre su potencial a largo plazo basada *únicamente* en estos fundamentales. Si 'EXPANSION_PLANES' o 'ACUERDOS' contienen texto relevante y no genérico, sintetízalo y comenta su posible impacto estratégico, por ejemplo: "Los planes de expansión de <strong>{data['NOMBRE_EMPRESA']}</strong> hacia [mercados/tecnologías] representan un catalizador significativo para el crecimiento futuro, mientras que los recientes acuerdos [tipo de acuerdo] podrían asegurar su posición competitiva a largo plazo." Si la información es demasiado breve o indica 'no disponible/no traducible', la IA debe elaborar sobre la importancia general de tales estrategias para el sector de la empresa o para la empresa en sí, sin inventar detalles específicos, por ejemplo: "Si bien los detalles específicos de los planes de expansión no están disponibles, en el sector de [Sector de la empresa], la capacidad de adaptarse y buscar nuevos mercados es fundamental para sostener el crecimiento a largo plazo, y cualquier iniciativa en esta dirección sería un punto positivo para la valoración fundamental."].</p>
